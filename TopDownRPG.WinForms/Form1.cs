...
public partial class Form1 : Form
{
	public Form1()
	{
		...
		_game.WindowMinimumUpdateRate.MinimumElapsedTime = new TimeSpan(5);
		_game.MinimizedMinimumUpdateRate.MinimumElapsedTime = new TimeSpan(5);
